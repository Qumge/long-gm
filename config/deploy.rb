...
set :domain, 'heyen@47.106.12.215' #在服务器~/.ssh/authorized_keys 里面写入你的id_rsa.pub就不用密码登录
#服务器中项目部署位置
set :deploy_to, '/opt/rails-app/longsheng-gm'
#git代码仓库
set :repository, 'git@github.com:Qumge/long-gm.git'
#git分支
set :branch, 'master'
#配置rvm位置
