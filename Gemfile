...
source 'https://rails-assets.org' do
  gem 'rails-assets-bootstrap', '~> 3.3.0'
  gem 'rails-assets-bootstrap-directional-buttons'
  gem 'rails-assets-admin-lte' , '~> 2.3.6'
  gem 'rails-assets-font-awesome', '~> 4.3.0'
  gem 'rails-assets-jquery-form-validator'
  gem 'rails-assets-bootstrap-treeview'
  #gem 'rails-assets-jstree-bootstrap-theme'
  #gem 'rails-assets-echarts'
...
gem 'paper_trail'                           # rails admin 分页
